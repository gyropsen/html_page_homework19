            ...
            <div class="row text-center">
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <form>
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal">Авторизация</h4>
                            </div>
                            <div class="card-body">
                                <p class="mb-3">
                                    <label for="name" class="form-label">Name</label>
                                    <input class="form-control" type="text" id="name"
                                           aria-label="default input example" placeholder="name">
                                ...
                                <button type="button" class="w-100 btn btn-lg btn-success">Отправить</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="text-center">
                ...
                <p class="d-inline-flex gap-1">
                    ...
                    <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
                       aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?
                    </a>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                            <div class="card card-body">
                                Ваша покупка придет в ближайший пункт выдачи заказов.
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="collapse multi-collapse" id="multiCollapseExample3">
                            <div class="card card-body">
                                Наша компания отвечает за свои слова.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="alert alert-primary" role="alert">
                            <a href="#" class="alert-link">Новый</a>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="alert alert-warning" role="alert">
                            <a href="#" class="alert-link">Обработка</a>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="alert alert-success" role="alert">
                            <a href="#" class="alert-link">Обработан</a>
                        </div>
                    </td>
                </tr>
                <tr>
